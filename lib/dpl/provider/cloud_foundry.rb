  ...
  class Provider
    class CloudFoundry < Provider
      ...
      def initial_go_tools_install
        context.shell 'wget http://go-cli.s3-website-us-east-1.amazonaws.com/releases/v6.8.0/cf-linux-amd64.tgz -q0 cf-linux-amd64.tgz && tar -zxvf *cf-linux-amd64.tgz && rm *cf-linux-amd64.tgz'
      end
